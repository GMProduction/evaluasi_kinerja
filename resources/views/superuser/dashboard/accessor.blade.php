@if ($data == 'content')
    ...
    <div role="tablist" class="row" id="tablist">
        <div class="items-tab col-3 row"  id="menu-vendor">
...
@elseif($data == 'script')
    <script>
        ...
        function elVendor(data) {
            return '<a href="/penilaian?vendor=' + data['id'] +'">' +
                '' +
                '</a>';
        }
        function getVendor() {
            ...
            $.get('/vendor', function(data) {
                ...
                $.each(data, function(key, value) {
                    vendor.append(' <a href="/penilaian?vendor=' + value['id'] +
                        ...
                        ' <div class="w-100"><p  class="nama">'+ value['vendor']['name'] +'</p><p class="email">'+value['email']+'</p> <h6 class="t-right number"> '+value['package_vendor_going'].length+' </h6> </div>' +
                        '                    </div>\n' +
