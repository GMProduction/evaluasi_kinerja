...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="header_img"> <img src="https://awsimages.detik.net.id/community/media/visual/2021/05/05/takeuchi-miyu_43.jpeg?w=700&q=90" style="object-fit: cover" alt=""> </div>
        </div>
    </header>
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> 
                ...
                <span
                        class="nav_logo-name">Evaluasi Kinerja</span> </a>
